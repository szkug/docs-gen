![Now in Android](images/nia-splash.jpg "Now in Android")
...
**Learn how this app was designed and built in the [design case study](https://goo.gle/nia-figma), [architecture learning journey](ArchitectureLearningJourney.md) and [modularization learning journey](ModularizationLearningJourney.md).**
...
![Screenshot showing For You screen, Interests screen and Topic detail screen](images/screenshots.png "Screenshot showing For You screen, Interests screen and Topic detail screen")
...
[architecture learning journey](ArchitectureLearningJourney.md).

# Modularization

The **Now in Android** app has been fully modularized and you can find the detailed guidance and
description of the modularization strategy used in
[modularization learning journey](ModularizationLearningJourney.md).
...
Find out more about the [UI architecture here](ArchitectureLearningJourney.md#ui-layer).
